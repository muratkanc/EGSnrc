...
QString Tasks::exeName() {
    QString exe_name = fname;
    exe_name.truncate(exe_name.lastIndexOf("."));
#ifdef WIN32
    exe_name += ".exe";
#endif
    ename = exe_name;
...
QString Tasks::objName() {
    QString obj_name = fname;
    obj_name.truncate(obj_name.lastIndexOf("."));
#ifdef WIN32
    obj_name += ".obj";
#else
    obj_name += ".o";

...
public slots:
    ...
    bool itsAZip() {
        EGS_Archive* archi = new EGS_Archive(this);
        bool isAZippo = false;
...
private:
    ...
    QString egsHome();
    QString confFile() {
        QString le_conf = field("egs_conf").toString();
        return le_conf+".conf";
    }
    QString canonical() {
        return field("Canonical").toString();
    }
    QString my_machine() {
        return field("conf_name").toString();
    }
    bool needsUCs() {
        return field("copyUCs").toBool();
    }
...
//************************************************************************
    ...
    */
    ...
    void createDir( QString dir, const QString & def) {
        createDir( dir, false, def );
    }
    void createDir( QString dir, bool critical) {
        createDir( dir, critical, QString() );
    }
    void createDir( QString dir) {
        createDir( dir, false, QString() );
    }

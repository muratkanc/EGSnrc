...
are also sampled, but neutrinos are not modeled. In this case, 
\ref EGS_RadionuclideSpectrum returns zero. These disintegrations may set
the energy level of the daughter isotope to an excited state, leading to the
emission of transition photons.
...
- X-Ray fluorescence and Auger events emit a photon or electron from a sampled 
...
be assigned the same shower index and time of emission as the most recent
disintegration or internal transition.
